...
export const Message = () => {
	return (
		<div className="w-dvw h-[65dvh] bg-[url(/images/officialgsbe_cover_about.jpeg)] bg-cover bg-center relative after:content-[''] after:absolute after:inset-0  after:bg-black/50 after:z-0">
			<div className="mx-auto text-white text-center p-20 relative z-10">
				<h1 className="font-anton uppercase font-stretch-condensed text-5xl py-6">
					Members in good standing
				</h1>
				<h2 className=" uppercase font-extrabold text-3xl tracking-[5px] ">
					Dedication. Expertise. Passion.
				</h2>
				<p className="py-10 pb-18 px-80 font-semibold text-2xl tracking-wide  ">
				...
				<Button className="rounded-none bg-[#282626] hover:bg-white hover:text-[#254152] tracking-wide text-lg font-light p-6">
					View Full List
				</Button>
			</div>
		</div>
