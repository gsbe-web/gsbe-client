		...
		<div className="leading-8">
			...
			<div className="flex flex-col items-start py-20 md:flex-row">
				...
				<div className="flex flex-1 items-start md:pl-16">
					<div>
						<h2 className="mb-4 text-xl font-semibold md:text-xl">Volunteer</h2>
						<p className="text-sm tracking-wider md:text-base">
							Join us in making a difference! Become a volunteer and help drive
							our initiatives forward. Whether you&apos;re a student,
			...
			<div className="flex flex-col items-start pb-10 md:flex-row">
				...
				<div className="flex flex-1 items-start md:pl-16">
					<div>
						<h2 className="mb-4 text-xl font-semibold md:text-xl">Fundraise</h2>
						<p className="text-sm tracking-wider md:text-base">
							Support our mission by organizing a fundraiser! Every contribution
							helps us advance biomedical engineering in Ghana and improve
							healthcare access. Rally your community and let&apos;s make a
							meaningful difference together.
						</p>
					</div>
				</div>
			</div>
